...
entity counter_Nbits is
    generic(cnt_width: natural:= 22); --selección de la resolución del contador
...
architecture Behavioral of counter_Nbits is
    ...
    --esta señal se usa para detectar que se probocó un desborde (máxima cuenta)
    signal counter  : unsigned(cnt_width-1 downto 0);
    --esta señal se usa para contar
begin
