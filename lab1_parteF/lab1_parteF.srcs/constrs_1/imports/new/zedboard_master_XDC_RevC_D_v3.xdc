...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {counter_output[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {counter_output[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {counter_output[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {counter_output[3]}];  # "LD3"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {counter_select[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {counter_select[1]}];  # "SW1"
