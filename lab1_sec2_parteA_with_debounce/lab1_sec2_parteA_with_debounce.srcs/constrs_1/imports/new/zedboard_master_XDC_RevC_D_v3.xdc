...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {sis_clock}];  # "GCLK"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {sis_pwm_out}];  # "LD0"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {sis_reset}];  # "BTNC"
#set_property PACKAGE_PIN R16 [get_ports {reset}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {sis_load}];  # "BTNL"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {sis_duty_cycle[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {sis_duty_cycle[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {sis_duty_cycle[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {sis_duty_cycle[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {sis_duty_cycle[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {sis_duty_cycle[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {sis_duty_cycle[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {sis_duty_cycle[7]}];  # "SW7"
